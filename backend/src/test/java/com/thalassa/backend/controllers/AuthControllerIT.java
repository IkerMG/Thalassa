...
class AuthControllerIT {
  ...
  void register_duplicateEmail_returns400() {
    ...
    Map<String, String> dup =
        Map.of(
            ...
            "password", "password123");
    ResponseEntity<Map> second = restTemplate.postForEntity("/api/auth/register", dup, Map.class);
  ...
  void login_validCredentials_returns200WithToken() {
    ...
    restTemplate.postForEntity(
        "/api/auth/register",
        Map.of("email", email, "username", "user_" + unique, "password", "password123"),
        Map.class);
  ...
  void login_wrongPassword_returns401() {
    ...
    ResponseEntity<Map> response =
        restTemplate.postForEntity(
            "/api/auth/login", Map.of("email", email, "password", "wrongpassword"), Map.class);
