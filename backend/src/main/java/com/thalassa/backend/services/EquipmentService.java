...
public class EquipmentService {
  ...
  public EquipmentService(
      EquipmentRepository equipmentRepository, AquariumRepository aquariumRepository) {
  ...
  public List<EquipmentResponse> listEquipment(Long aquariumId) {
    ...
    return equipmentRepository.findByAquariumId(aquariumId).stream()
  ...
  public EquipmentResponse updateEquipment(Long equipmentId, EquipmentRequest request) {
    ...
    Equipment equipment =
        equipmentRepository
            .findByIdAndAquariumUserId(equipmentId, user.getId())
   ...
   *
   * <p>Fórmula por equipo: kWh/mes = (powerWatts / 1000.0) * hoursPerDay * 30 → double (magnitud
   * física) coste = kWh/mes * electricityPriceKwh → BigDecimal (dinero)
   */
            ...
            .map(
                e -> {
                  ...
                  BigDecimal monthlyCost =
                      BigDecimal.valueOf(kWhPerMonth)
