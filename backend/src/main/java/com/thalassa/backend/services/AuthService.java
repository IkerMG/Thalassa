...
public class AuthService {
  ...
  /**
   * Registra un nuevo usuario con plan FREE y contraseña cifrada con BCrypt. No genera JWT: el
   * cliente debe llamar a /login tras el registro.
   *
   ...
   *
   * @throws org.springframework.security.core.AuthenticationException si las credenciales son
   *     incorrectas.
   */
  @Transactional
  ...
  public AuthResponse refresh(String plainToken, String userAgent, String ip) {
    RefreshTokenService.RotationResult result =
        refreshTokenService.validateAndRotate(plainToken, userAgent, ip);
