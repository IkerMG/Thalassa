...
public class ScraperClientConfig {
   ...
   *
   * <p>- baseUrl inyectada desde python.service.url (con fallback a localhost:8001). - Timeout de
   * conexión y lectura: 8 segundos. - SimpleClientHttpRequestFactory: usa JDK HttpURLConnection,
