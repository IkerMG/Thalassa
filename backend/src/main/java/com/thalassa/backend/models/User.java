...
public class User implements UserDetails {
  ...
  /**
   * Spring Security uses getUsername() as the principal identifier. We use email as the login key,
   * so this must return email, not the display username. NOTE: Lombok's getter for the 'username'
   * field is suppressed by this override. Use getDisplayUsername() to access the display name.
   */
  @Override
