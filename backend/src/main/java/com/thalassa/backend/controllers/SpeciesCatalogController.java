...
public class SpeciesCatalogController {
  ...
  /**
   * GET /api/species?search= Busca especies por nombre común o científico (case-insensitive). Sin
   * parámetro devuelve el catálogo completo.
   */
  @GetMapping
  ...
  /** GET /api/species/{id} Detalle de una especie del catálogo. */
  @GetMapping("/{id}")
