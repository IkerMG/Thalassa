...
public class ChatController {
  ...
  /**
   * POST /api/chat Proxy al asistente IA Gemini con rate-limiting por plan. Siempre devuelve 200;
   * si el modelo falla, errorCode lo indica. Devuelve 429 si el usuario FREE ha superado el límite
   * diario.
   */
  @PostMapping
  ...
  /** GET /api/chat/usage Returns today's message count and the plan limit (-1 = unlimited). */
  @GetMapping("/usage")
