...
public class LivestockController {
  ...
  /**
   * PUT /api/livestock/{id} Actualiza los datos de un espécimen (nombre, categoría, reef-safe,
   * cantidad).
   */
  @PutMapping("/{id}")
  ...
  /** DELETE /api/livestock/{id} Elimina un espécimen del acuario (baja o venta). */
  @DeleteMapping("/{id}")
